...
for(const marker of ['manifest.webmanifest','adminPwaInstall','installAdminPwa','adminPwaNetwork','adminPwaUpdate','admin-pwa-script-v2320','Versión v2.3.71'])if(!admin.includes(marker))throw new Error('index.html: falta PWA Admin '+marker);
...
for(const marker of ['id="viewMenuLink" class="hidden"','href="#"','YUMMY_CLIENT_MENU_BASE','https://menu.yummypro.online/','https://jorge2610g.github.io/yummy-cliente-pruebas/','adminClientMenuUrl','menuLink.href=adminClientMenuUrl(menuSlug)','menuLink.classList.remove("hidden")'])if(!admin.includes(marker))throw new Error('index.html: falta enrutamiento seguro del acceso Ver menú '+marker);
