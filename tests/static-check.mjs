...
for(const marker of ['manifest.webmanifest','adminPwaInstall','installAdminPwa','adminPwaNetwork','adminPwaUpdate','admin-pwa-script-v2320','Versión v2.3.58'])if(!admin.includes(marker))throw new Error('index.html: falta PWA Admin '+marker);
