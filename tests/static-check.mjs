...
for(const marker of ['manifest.webmanifest','adminPwaInstall','installAdminPwa','adminPwaNetwork','adminPwaUpdate','admin-pwa-script-v2320','Versión v2.3.32'])if(!admin.includes(marker))throw new Error('index.html: falta PWA Admin '+marker);
...
for(const marker of ['retail_online_orders','Pedidos online activos','Venta online','Ver tienda online','retail_orders','Versión v2.3.32'])if(!admin.includes(marker))throw new Error('index.html: falta tienda online retail admin '+marker);
